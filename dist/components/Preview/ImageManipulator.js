...
var ImageManipulator = /*#__PURE__*/function (_Component) {
  ...
  function ImageManipulator() {
    ...
    _defineProperty(_assertThisInitialized(_this), "applyTransformationsToNewCanvas", function () {
    ...
    _defineProperty(_assertThisInitialized(_this), "replaceCanvas", function (oldCanvas) {
    ...
    _defineProperty(_assertThisInitialized(_this), "saveImage", function () {
      ...
      var _ref = filerobot.uploadParams || {},
          dir = _ref.dir,
          uploadParams = _objectWithoutProperties(_ref, ["dir"]);
      ...
      if (!processWithCloudService) {
        ...
        var triggerUpload = function triggerUpload() {
          ...
          if (overrides.keepPropsAndMeta || overrides.keepPropsAndMeta !== false && keepPropsAndMeta) {
            properties = _objectSpread({}, imageProperties);
            meta = _objectSpread({}, imageMeta);
          }

          if (overrides.imageProperties && Object.keys(overrides.imageProperties).length > 0) {
            properties = _objectSpread(_objectSpread({}, properties), overrides.imageProperties);
          }

          if (overrides.meta && Object.keys(overrides.meta).length > 0) {
            meta = _objectSpread(_objectSpread({}, meta), overrides.imageMeta);
          }
        ...
        if (isSaveAs && filerobot.onSaveAs) {
          var exitFullscreenModal = function exitFullscreenModal() {
            return (0, _fullScreenHandle.toggleModalFullscreen)(elementId, true);
          };
    ...
    _this.originalCanvas = /*#__PURE__*/(0, _react.createRef)();
    _this.editedCanvas = /*#__PURE__*/(0, _react.createRef)();
    return _this;
  }
  ...
  _createClass(ImageManipulator, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_jsxRuntime.Fragment, {
        children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_styledComponents.Canvas, {
          ref: this.originalCanvas,
          id: "".concat(editorWrapperId, "_").concat(_config.ORIGINAL_CANVAS_ID),
          className: "filerobot-original-canvas"
        }, this.state.canvasOriginalKey), /*#__PURE__*/(0, _jsxRuntime.jsx)(_styledComponents.Canvas, {
